...
INSERT INTO Books (ID, Code, NewEntry, Title, Price, Publisher, Pages, Format, DatePublished, Edition, Theme, Category) VALUES
...
ALTER TABLE Books MODIFY COLUMN Author char(20);
ALTER TABLE Books DROP COLUMN Author;
ALTER TABLE `lib`.`Books` ADD UNIQUE `idx_ID` (`ID`);
ALTER TABLE `Books` DROP INDEX `idx_ID`;
